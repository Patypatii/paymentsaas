...
export default function About() {
    ...
    return (
        <Layout title="About Us - Paylor">
            ...
            <div className="relative pt-24 pb-16 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                        We are building the <span className="text-blue-400">Financial Rail</span> <br /> for African Enterprises.
                    </h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-16">
                        <div>
                            ...
                            <h2 className="text-3xl font-bold text-white mb-4">Simplify Payments to Amplify Growth</h2>
                        ...
                        <div>
                            ...
                            <h2 className="text-3xl font-bold text-white mb-4">The Standard for Digital Commerce</h2>
                            <p className="text-gray-400 leading-relaxed">
            ...
            {/* Stats */}
            <div className="py-16 bg-white/5 border-y border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="glass-card p-8 rounded-xl border border-white/10">
                            ...
                            <p className="text-gray-400">We start with the customer and work backwards. We work vigorously to earn and keep customer trust.</p>
                        </div>
                        <div className="glass-card p-8 rounded-xl border border-white/10">
                            ...
                            <p className="text-gray-400">Owners think long term and don't sacrifice long-term value for short-term results. We act on behalf of the entire company.</p>
                        </div>
                        <div className="glass-card p-8 rounded-xl border border-white/10">
                            <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center text-purple-400 mb-6">
                                <Heart className="h-6 w-6" />
                            </div>
                            <h3 className="text-xl font-bold text-white mb-3">Earn Trust</h3>
                            <p className="text-gray-400">We listen attentively, speak candidly, and treat others with respect. We are vocally self-critical.</p>
                        </div>
                    </div>
                </div>
            </div>
