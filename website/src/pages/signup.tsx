  ...
  return (
    <Layout title="Sign Up - Paylor" description="Create your account to start accepting payments.">
      <div className="relative min-h-[calc(100vh-200px)] flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 w-full max-w-md space-y-8 glass-card bg-surface/50 backdrop-blur-sm p-8 rounded-2xl border border-border shadow-xl">
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight text-main">Create your account</h1>
