    ...
    return (
        <div ref={ref} className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-radial from-blue-900/20 to-transparent opacity-50" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                >
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-400 mb-10 text-balance">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                        ...
                        <Link
                            href="/contact"
                            className="inline-flex items-center justify-center px-8 py-3.5 text-base font-medium text-gray-300 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:text-white transition-all backdrop-blur-sm"
                        >
                            Let's Talk
                        </Link>
                    </div>
                    ...
                    <motion.div
                        ...
                        className="relative mx-auto max-w-5xl rounded-xl border border-white/10 bg-white/5 shadow-2xl overflow-hidden glass-panel"
                    >
                        <img
